...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/conda-tree-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6743&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/conda-tree-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `conda-tree` can be installed with:

```
conda install conda-tree
```

It is possible to list all of the versions of `conda-tree` available on your platform with:
